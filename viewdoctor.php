...
<?php
        ...
        $sql= "SELECT * FROM thong_tin_tai_khoan_doctor WHERE id_tai_khoan = '$id_login1'";
...
<div class="panel-body inf-content">
    <div class="row">
        ...
        <div class="col-md-6">
            <strong>THÔNG TIN TÀI KHOẢN BÁC SĨ</strong><br>
                ...
                <tbody>
					...
					<tr>
						<td>
                            <strong>
                                <span class="glyphicon glyphicon-cloud text-primary"></span>  
                                <a href="doctor_update.php">Chỉnh sửa thông tin</a>                                            
                            </strong>
                        </td>
					</tr>
                </tbody>
